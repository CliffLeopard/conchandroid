package com.cliff.conch.scene.coroutine.imitate.lua
...
object SymCoroutines {
    private val coroutine0: SymCoroutine<Int> = SymCoroutine.create<Int> { param: Int ->
    ...
    private val coroutine1: SymCoroutine<Int> = SymCoroutine.create { param: Int ->
...
suspend fun testLuaSymCoroutine() {
    SymCoroutine.main {
        println("main 0")
